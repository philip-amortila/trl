...
SESSIONS = [
    (
        "tr_gkd_0",
        "tr_gkd_1",
        "run_gsm8k_gkd_T-Qwen2-1.5B-Instruct_tr0.sh",
        "run_gsm8k_gkd_T-Qwen2-1.5B-Instruct_tr1.sh",
    ),
    (
        "tr_entropy_0",
        "tr_entropy_1",
        "run_gsm8k_opd_entropy_T-Qwen2-1.5B-Instruct_tr0.sh",
        "run_gsm8k_opd_entropy_T-Qwen2-1.5B-Instruct_tr1.sh",
    ),
    (
        "tr_expectation_0",
        "tr_expectation_1",
        "run_gsm8k_opd_expectation_T-Qwen2-1.5B-Instruct_tr0.sh",
        "run_gsm8k_opd_expectation_T-Qwen2-1.5B-Instruct_tr1.sh",
    ),
    (
        "tr_stochastic_0",
        "tr_stochastic_1",
        "run_gsm8k_opd_stochastic_T-Qwen2-1.5B-Instruct_tr0.sh",
        "run_gsm8k_opd_stochastic_T-Qwen2-1.5B-Instruct_tr1.sh",
    ),
]
